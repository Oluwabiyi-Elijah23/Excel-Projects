...
The README can be viewed directly on GitHub. However, GitHub may not be able to preview certain Excel (`.xlsx` or `.xls`) files directly in the browser, including the main project workbook and dataset.
...
The project was completed in three major phases:
